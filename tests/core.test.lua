...
do
  ...
  -- 2026-09-11 live: a restored tab that started with /clear was named "/clear" by the Claude
  -- extension, but Shepherd skipped the command and named it after a later task notification,
  -- so it couldn't close the tab.
  local clearHead = '{"type":"user","isMeta":true,"message":{"role":"user","content":"<local-command-caveat>Caveat: The messages below were generated by the user while running local commands.</local-command-caveat>"}}\n'
